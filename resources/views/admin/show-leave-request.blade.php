                ...
                <div class="p-6 text-gray-900">
                    ...
                    <div class="mt-8">
                        ...
                        <div class="flex space-x-4">
                            <form method="POST" action="{{ route('admin.leave.request.approve', $leaveRequest->id) }}" class="inline">
                                @csrf
                                @method('PUT')
                                <div class="mb-4">
                            ...
                            <form method="POST" action="{{ route('admin.leave.request.reject', $leaveRequest->id) }}" class="inline">
                                @csrf
                                @method('PUT')
                                <div class="mb-4">
